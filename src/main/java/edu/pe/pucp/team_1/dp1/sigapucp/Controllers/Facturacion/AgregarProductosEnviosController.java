...
public class AgregarProductosEnviosController implements Initializable {
    ...
    public void llenar_productos_tabla(){
        ...
        columna_cantidad.setCellValueFactory((TableColumn.CellDataFeatures<OrdenCompraxProducto, String> p) -> new ReadOnlyObjectWrapper(p.getValue().get("cantidad_en_envios")));
